...
class bg_screen extends StatefulWidget {
  final dynamic parseWeatherData;
  final dynamic parseAirData;
  final dynamic parseWeeklyData;
  bg_screen({this.parseWeatherData, this.parseAirData, this.parseWeeklyData});

  @override
  _bg_screenState createState() => _bg_screenState();
}

class _bg_screenState extends State<bg_screen> {
   Model model = Model();
 ...
 //late List<double> seventemp;
  ...
  void updateData(dynamic weatherData, dynamic airData, dynamic weeklyData) {
    ...
    num temp2 = weatherData['main']['temp'].toDouble();
